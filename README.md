...
- **計時頁（Today / Logging）**：
  - 進入即自動開始計時，顯示目前進行的行為與已過時間
  - 一鍵輸入/選擇行為，常用標籤快速點選，極簡低摩擦

- **日曆＋當日時間軸頁（Review）**：
  - 日曆切換日期，檢視任一天完整行為軸
  - 垂直時間軸顯示每段行為與持續時間，還原真實一天

- **統計與視覺化頁（Insights）**：
  - 圓餅圖/折線圖檢視當天、當週、當月各分類時間分布
  - 支援分類篩選（如只看「學習」），折線圖與圓餅圖皆可即時切換
  - 可快速檢視如「本週每天讀書時數」等細項趨勢
  - 標籤僅用於時間軸細節，不進統計圖

- **其他功能**：
  - 常用標籤、資料匯出（CSV/JSON）、深色模式、PWA 安裝

## 🏷️ 分類與標籤設計

- **行為分類（Category）**：睡覺、飲食、學習、工作、娛樂、社交、雜事/空轉（可自定義）
